...
import { LuCircleGauge, LuImage, LuX } from "react-icons/lu";
...
const EmojiPickerPopup = ({ icon, onSelect }) => {
	...
	return (
		<div className="flex flex-col md:flex-row items-start gap-5 mb-6">
			...
			>
				<div className="w-12 h-12 flex items-center justify-center text-2xl bg-[#EEEEEE] text-primary rounded-lg">
					{icon ? (
