	...
	const handleSignUp = async (e) => {
		...
		try {
			...
			if (error.response && error.response.data.message) {
				...
				setError("error is registering, try again! ");
			}
		}
	};
	...
	return (
		<AuthLayout>
			<div className="lg:w-[100%] h-auto md:h-full mt-10 md:mt-0 flex flex-col justify-center">
				<h3 className="text-xl font-semibold text-[#EEEEEE]">Create an Account</h3>
				<p className="text-xs text-primary mt-[5px] mb-6">
